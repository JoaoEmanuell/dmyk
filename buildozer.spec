...
requirements = python3,kivy,certifi==2022.9.24,charset-normalizer==2.1.1,idna==3.4,requests==2.28.1,urllib3==1.26.13,plyer==2.1.0
...
# android.add_activities = com.example.ExampleActivityProgressBar.java
