...
def test_answer():
    ...
    response = api_control.upload(
        "/home/emanuel/Música/Outros/Rap do The Last of Us 2 - SE EU TE PERDER  Ft Amanda Areia.mp3"
    )
    ...
    assert (
        response["filename"]
        == "Rap_do_The_Last_of_Us_2_-_SE_EU_TE_PERDER_Ft_Amanda_Areia.mp3"
    )
